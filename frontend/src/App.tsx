      ...
      <main>
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            ...
            <h1 id="hero-title">
              Make room for your <em>next move.</em>
            </h1>
            ...
            <div className="hero-note">
              <span className="note-line" /> Built around the way you work.
            </div>
          </div>
            ...
            <div className="visual-card">
              ...
              <div className="visual-resume">
                ...
                <span className="file-text">
                  ...
                  <small>Keep your experience close.</small>
                </span>
        ...
        >
          ...
          <p>
            Create an account, add your resume, and keep your career details
            within reach.
          </p>
